...
//                var_maxrpm_update_config(
//								power_care.chassis_max_power, kOrange);  //MaxRpm数值
            } else {
//                var_maxrpm_update_config(
//								power_care.chassis_max_power, kCyan);  //MaxRpm数值
            }
            var_level_update_config(comm.vision_is_aimed);  //Level数值
