...
void BoardCommunicationTX()
{
    ...
    HAL::UART::Data uart1_tx_buffer{send_str2, sizeof(send_str2)}; 
...
void Communication(void const * argument)
{
    ...
    for(;;)
    {
        ...
        vofa_send(gimbal_target.target_pitch1, MotorJ4340.getAngleDeg(1), gimbal_target.target_pitch2, MotorJ4310.getAngleDeg(1), 0.0f, 0.0f);
